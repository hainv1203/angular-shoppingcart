...
export class AppComponent implements OnInit, DoCheck {
  ...
  constructor(public productService: ProductService) {
    console.log("constructor cua AppComponent");
  }
  ngOnInit() {
  ...
  removeProduct(productId: number) {
    ...
    const iRemoved = this.productService.removeProduct(productId);
    if (iRemoved) alert("Da xoa san pham " + nameProduct);
    else alert("Xoa san pham " + nameProduct + " khong thanh cong!");
  }
